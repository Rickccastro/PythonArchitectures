...
from interface.serializers.order_serializer import OrderInputSerializer, OrderOutputSerializer
...
class OrderListView(APIView):
    ...
    def get(self, request: Request) -> Response:
        orders = container.list_orders_uc.execute()
    ...
    def post(self, request: Request) -> Response:
        ...
        try:
            order = container.create_order_uc.execute(**serializer.validated_data)
